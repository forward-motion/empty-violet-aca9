...
```
npm create cloudflare@latest -- --template=cloudflare/templates/empty-violet-aca9
```

## Preview Deployment

A live public deployment of this template is available at [https://empty-violet-aca9.templates.workers.dev](https://empty-violet-aca9.templates.workers.dev)
